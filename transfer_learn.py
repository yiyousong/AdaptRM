...
parser.add_argument('--out_list',default=None,help="'Adrenal','Brainstem','Cerebellum','Cerebrum','Colon','EndoC','endometrial','Heart','HSC','Hypothalamus','islet','Kidney','Liver','lung','lymphocyte','Muscle','ovary','Prostate','Rectum','RWPE','Skin','Stomach','Testis','Thyroid','Urinary','ac4c','hm5c','m7g','h_b','h_k','h_l','m_b','m_h','m_k','m_l','m_t','r_b','r_k','r_l'" )
